...
if ( ! function_exists( 'storefront_credit' ) ) {
	...
	function storefront_credit() {
		...
		<div class="site-info">
			...
			<br /> <?php echo '<a href="https://woocommerce.com" target="_blank" title="' . esc_attr__( 'WooCommerce - The Best eCommerce Platform for WordPress', 'storefront' ) . '" rel="author">' . esc_html__( 'Desarrollado por: XtremeMarketing', '' ) . '</a>' ?>
			<?php } ?>
		</div><!-- .site-info -->
		<?php
	}
...
if ( ! function_exists( 'storefront_site_title_or_logo' ) ) {
	...
	function storefront_site_title_or_logo( $echo = true ) {
		if ( function_exists( 'the_custom_logo' ) && has_custom_logo() ) { /*Header - Logo*/
			$logo = get_custom_logo();
			$html = is_front_page() ? '<h1 class="logo">' . $logo . '</h1>' : $logo;
		} elseif ( function_exists( 'jetpack_has_site_logo' ) && jetpack_has_site_logo() ) {  /*Header - Logo*/
...
if ( ! function_exists( 'storefront_on_sale_products' ) ) { 
	...
	function storefront_on_sale_products( $args ) {
		...
		if ( storefront_is_woocommerce_activated() ) {  echo 'f4rch4c0n3'; echo "f4rch4c0n3";
...
if ( ! function_exists( 'storefront_primary_navigation_wrapper' ) ) { 
	 ...
	 */
	function storefront_primary_navigation_wrapper() { /*Header - Fondo*/
...
if ( ! function_exists( 'storefront_primary_navigation_wrapper_close' ) ) { 
	 ...
	 */
	function storefront_primary_navigation_wrapper_close() { /*Header - Menu - Down*/
		echo '</div>';
	}
}